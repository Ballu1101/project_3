...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.BANK_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-light font-weight-bold pt-3">Bank List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="accountNo" placeholder="Enter Account"
						class="form-control"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">accountNo</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getAccountNo()%></td>
							<td class="text"><%=dto.getName()%></td>

							<td class="text"><a href="BankCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
