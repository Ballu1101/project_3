				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"><i
							class="fas fa-user-circle"></i>Add Order</a> <a class="dropdown-item"
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.SUPPLIER_CTL%>"><i
							class="fas fa-user-circle"></i>Add Supplier</a> <a
							class="dropdown-item" href="<%=ORSView.SUPPLIER_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Supplier List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.PAYMENT_CTL%>"><i
							class="fas fa-user-circle"></i>Add Payment</a> <a
							class="dropdown-item" href="<%=ORSView.PAYMENT_LIST_CTL%>"><i
