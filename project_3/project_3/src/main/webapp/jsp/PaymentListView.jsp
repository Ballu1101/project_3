...
<body class="hm">
	...
	<%-- 	<%
				List list1 = (List) request.getAttribute("typeList");
		 %>
		 --%>
			...
			%>
			<center>
				<h1 class="text-light font-weight-bold pt-3">Payment List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<%-- <div class="col-sm-2">
					<input type="text" name="transactionId" placeholder="Enter TransactionId"
						class="form-control"
						value="<%=ServletUtility.getParameter("transactionId", request)%>">
				</div> --%>
				&emsp;
 ...
 <%--  &emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("Type", String.valueOf(dto.getType()), list1)%></div>
					...
					<table class="table table-bordered table-dark table-hover">
						<thead>
							<tr style="background-color: #8C8C8C;">
								...
								<th width="15%" class="text">transactionId</th>
						...
						<tbody>
							<tr>
								...
								<td class="text"><%=dto.getTransactionId()%></td>
